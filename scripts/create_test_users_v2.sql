...
-- 商家端测试账号 (使用正确的字段名)
INSERT INTO merchants (phone, password, name, status, is_open, rating, created_at, updated_at)
VALUES ('13800138001', '$2b$10$abcdefghijklmnopqrstuvwx', '测试商家', 'active', true, 5.0, NOW(), NOW())
ON DUPLICATE KEY UPDATE phone = phone;
